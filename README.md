...
Now that you have the verifier contracts, you can verify that the bytecode matches the contracts deployed in production that can be found below when using the right `solc` compiler version and compilation parameters, these details can be found on the Etherescan verification page for each contract:
